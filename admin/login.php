<?php
    ...
    if(isset($_POST['submit'])){
        ...
        if(!password_verify($password, $check_user_row['password'])){
            ...
            //get the user id to update last_login
            $user_id = $check_user_row['id'];
            //get the current time
            $date = time();

            $update_last_login = mysql_query("UPDATE users SET last_login = '$date' WHERE id = '$user_id'");
            $_SESSION['user'] = $check_user_row['full_name'];
            $_SESSION['user_id'] = $user_id;
            $_SESSION['permission'] = $check_user_row['permissions'];
